					...
					<div class="col-md-12 col-lg-7 offset-lg-1 offset-xl-0">
						<div class="hero-text">
							<div class="hero-text-tablecell">
								<h1>Wisata Daerah Tawangmangu</h1>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-10 offset-lg-1 text-center">
						<div class="hero-text">
							<div class="hero-text-tablecell">
								<h1>Kuliner Daerah Tawangmangu</h1>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-10 offset-lg-1 text-right">
						<div class="hero-text">
							<div class="hero-text-tablecell">
								<h1>Rekreasi Alam Daerah Tawangmangu</h1>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="section-title">
						...
						<p>Eksplor Berbagai Tempat di Tawangmangu</p>
					</div>
				</div>
			</div>
			<div class="row">
				<?php 
    // Batasi konten awal hanya 3
    $konten_awal = array_slice($konten, 0, 3); 
    foreach ($konten_awal as $uu) { ?>
				<div class="col-lg-4 col-md-6">
					<div class="single-latest-news">
						<div class="latest-news-bg" style="position: relative; width: 100%; height: 200px;">
							<img src="<?= base_url('template/upload/konten/' . $uu['foto']) ?>" class="img-fluid"
			...
			<div class="row">
				<div class="col-lg-12 text-center">
					<!-- Tombol untuk melihat lebih banyak konten -->
					<a href="<?= base_url('home/blog') ?>" class="boxed-btn">Selengkapnya</a>
				</div>
			</div>
